...
{	
	...
	vtx[0].color = vtx[1].color = vtx[2].color = vtx[3].color = 0x110000ff;
	vtx[4].color = vtx[5].color = vtx[6].color = vtx[7].color = 0x110000ff;
    ...
    //pDev->SetMaterial( &mtrl );
	vtx[1].color = vtx[2].color = vtx[5].color = vtx[6].color = 0xff00ff00;
	vtx[0].color = vtx[3].color = vtx[4].color = vtx[7].color = 0xff00ff00;
	...
	//pDev->SetMaterial( &mtrl );
	vtx[0].color = vtx[1].color = vtx[4].color = vtx[5].color = 0xffff0000;
	vtx[2].color = vtx[3].color = vtx[6].color = vtx[7].color = 0xffff0000;
